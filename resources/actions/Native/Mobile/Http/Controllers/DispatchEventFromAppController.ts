...
/**
* @see \Native\Mobile\Http\Controllers\DispatchEventFromAppController::__invoke
* @see vendor/nativephp/mobile/src/Http/Controllers/DispatchEventFromAppController.php:9
